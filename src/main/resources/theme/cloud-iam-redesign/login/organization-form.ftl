<#import "layout-cloud-iam.ftl" as layout>
<@layout.registrationCloudIamLayout displayMessage=!messagesPerField.existsError('username') displayInfo=(realm.password && realm.registrationAllowed && !registrationDisabled??); section>
    <#if section = "header">
        ${msg("signInSSO")}
    <#elseif section = "form">
        <div id="kc-form">
...
</@layout.registrationCloudIamLayout>
